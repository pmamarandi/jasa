...
<div class="caja web-50 formato_tabla centrar-contenido ">  
    <h3>Producto</h3>   <input class="boton_verde"  type="button" value="Seleccionar" onClick="location.href = 'ControladorProductosFactura.jsp' "><br>
            ...
            <input class="boton_verde"  type="submit" name="Añadir" value="Añadir"  onClick="document.forms.slibro.action='ControladorIngresarDetalleFactura.jsp'; document.forms.slibro.submit()">
        </div>
	...
	String result = port.listarDetalleFactura();
        out.println(result);
                      %>
        <br>
        <div class="grupo web-100 formato_tabla centrar-contenido "> 
            Subtotal: <input type="text" name="subTotal" value="<%=subTotal%>" size="6" readonly="readonly">
        <br><br>
