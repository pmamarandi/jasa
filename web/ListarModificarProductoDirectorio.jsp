            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                  <p class="category">Buscar en Directorio</p>
                                  <div class="content table-responsive table-full-width">
                                                                                                                                  
                                <form action="ListarModificarProductoDirectorio.jsp" method="post">                                                                                                                               
                                 <div class="col-md-3 form-group-sm">
                                   <input class="form-control border-input" type="te6xt" name='txtparametro' placeholder="Buscar..." size="15" maxlength="15" onkeypress="return val(event), return ValNum(event)" required>                                   
                                   <br>
                                 </div>
                   ...
                   if (longitud > 0) 
                        {
                            com.factime.ln.ws.FactimeLogicaNegocioDirectorio_Service servicedir = new com.factime.ln.ws.FactimeLogicaNegocioDirectorio_Service();
                            com.factime.ln.ws.FactimeLogicaNegocioDirectorio portdir = servicedir.getFactimeLogicaNegocioDirectorioPort();
                            String esTbldir = portdir.productosModificar(variableAencontrar,0);                                                  
                            out.println(esTbldir);
                        
                        } else 
                        {
                            
                          Integer cero = 0;
                            response.sendRedirect("ListarModificarProductoDirectorio.jsp?variableVacia=" + cero.toString() + "");  
