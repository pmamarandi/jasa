<%-- 
    ...
    Created on : 24-nov-2015, 20:39:11
    Author     : valea
--%>
...
<!DOCTYPE html><%
    ...
    %>
        <script>alert('Procedencia no registrada');</script>
    <%
    }
    }
    %>
<html lang="es">
  ...
  <body >
      ...
      <div class="grupo formato_tabla centrar-contenido "> 
            <form method="post" action="controladorIngresarProcedencia.jsp" name="registrar">
                <h2>Ingreso de Procedencia </h2><br>
