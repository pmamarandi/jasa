<%-- 
    Document   : AnularCompra
    Created on : 11-ene-2016, 8:46:25
    Author     : Jesus
--%>
...
<html lang="es">
  ...
  function setAnios(){
var valores = new Array("Elija un año",2014,2015, 2016, 2017,2018,2019,2020,2021,
                        2022,2023,2024,2025);
  ...
  <body onLoad="setAnios()">
    ...
    <div class="grupo web-100">
     ...
     <div class="grupo formato_tabla centrar-contenido"> 
            ...
            <div class="caja web-100 centro-contenido"> 
                <form action="AnularCompra.jsp" method="post" name="forma"> 
                <p>Ingresa la fecha: 
                        <select name="mes" required>
                            <option value="" selected>Elija un mes</option>
                    ...
                    <select name="anios">
                        <option value="0" selected>Elija un año</option>
                    </select>
                ...
                try {
                    ...
                    String esTbl = port.listarFacturasActivasAbastece(mes,anio);
