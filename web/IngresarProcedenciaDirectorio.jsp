		...
		<nav class="navbar navbar-default">
             <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">DIRECTORIO /Categorías</a>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-4">
                        <div class="card">
                            ...
                            <div class="content">
                                <form id="form1" method="post" action="controladorIngresarProcedenciaDirectorio.jsp" name="registrar">
                                    <div class="row">                                        
                                        <div class="col-md-5">
