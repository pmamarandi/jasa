<%-- 
    Document   : index
    Created on : 13-mar-2018, 15:13:14
...
<head>
	<title>IEJSA Tienda Online</title>
	<!--/tags -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="keywords" content="HHHHHHHIMPORTADORA DE REPUESTOS Y ACCESORIOS PARA LOS VEHÍCULOS, MAQUINARIA PESADA Y CAMIONES, Iejsa,Repuestos Quito , Importadora Automotriz, Respuestos electromecanicos Quito 
              Repuestos,Focos led, Alternadores , Luces , Automaticos , Autolujos" />
	<script>
...
<body>
			...
			<div class="item active">
				<div class="container">
					<div class="carousel-caption">
						...
						<p>Ùnicos con
							<span>6 MESES</span> de Garantía</p>
						<a class="button2" href="product.html">Buscar Faros </a>
					</div>
				</div>
			</div>
			<div class="item item2">
				<div class="container">
					<div class="carousel-caption">
						...
						<p>Los 
							<span>Mejores</span> están con nosotros</p>
						<a class="button2" href="product.html">Buscar mecánicos </a>
					</div>
				</div>
			</div>
			<div class="item item3">
				<div class="container">
					<div class="carousel-caption">
						...
						<p>Aprendende más en
							<span>nuestro foro</span>
						</p>
						<a class="button2" href="product.html">Ingresar Ahora </a>
					</div>
				</div>
			</div>
			<div class="item item4">
				<div class="container">
					<div class="carousel-caption">
						...
						<p>Encuentra entre nuestros
							<span>Saldos</span> lo que andabas buscando</p>
						<a class="button2" href="product.html">Buscar Descuentos </a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="ads-grid">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Nuestros Artículos
			...
			<div class="side-bar col-md-3">
				<div class="search-hotel">
					<h3 class="agileits-sear-head">Qué estas buscando?..</h3>
				...
				<!-- food preference -->
				<div class="left-side">
					<h3 class="agileits-sear-head">Marcas de Repuestos</h3>
					<ul>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">CASP</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">BESUTO</span>
						</li>
                                                <li>
							<input type="checkbox" class="checked">
							<span class="span">SULCARBON</span>
						</li>
                                                <li>
							<input type="checkbox" class="checked">
							<span class="span">FLOSSER</span>
						</li>
                                                <li>
							<input type="checkbox" class="checked">
							<span class="span">HOKEN</span>
						</li>
                                                <li>
							<input type="checkbox" class="checked">
							<span class="span">EJ LUX</span>
						</li>
                                                <li>
							<input type="checkbox" class="checked">
							<span class="span">MARCO</span>
						</li>
                                                <li>
							<input type="checkbox" class="checked">
							<span class="span">AUTOPAL</span>
						</li>
                                                <li>
							<input type="checkbox" class="checked">
							<span class="span">GAUSS</span>
						</li>
                                                <li>
							<input type="checkbox" class="checked">
							<span class="span">MARÍLIA</span>
						</li>
					</ul>
				</div>
				<!-- //food preference -->
				...
				<div class="customer-rev left-side">
					<h3 class="agileits-sear-head">Calificación de Producto</h3>
					<ul>
						<li>
							<a href="#">
				...
				<!-- cuisine -->
				<div class="left-side">
					<h3 class="agileits-sear-head">Procedencia</h3>
					<ul>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Norte America</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Taiwan</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
						...
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Brasil</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Malasia</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Japonés</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
				...
				<div class="deal-leftmk left-side">
					...
					<div class="special-sec1">
						...
						<div class="col-xs-8 img-deal1">
							<h3>Tira Led Blanco 50x50</h3>
							<a href="single.html">$34.85</a>
						</div>
					...
					<div class="special-sec1">
						...
						<div class="col-xs-8 img-deal1">
							<h3>Tira Led Azul 50x50</h3>
							<a href="single.html">$30.50</a>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="special-sec1">
	...
	java.lang.String resultbusqueda = port.productoMostrar("Alternadores");
	out.println(resultbusqueda);
	...
	<div class="copy-right">
		<div class="container">
			<p>© 2018 IEJSA. Todos los derechos reservados |Meapp Developers by
				<a href="http://lannyapp.ml">MapeCreative Cia.Ltda.</a>
			</p>
		</div>
	</div>
	<!-- //copyright -->
