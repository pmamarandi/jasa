<%-- 
    Document   : IngresarGasto
    Created on : 10/08/2018, 18:37:54
    Author     : Yesenia
--%>
...
<html lang="es">
    <head>
        ...
        <title>Factime |Gastos Administrador</title>
                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">GASTOS /Cloud software</a>
                        </div>
                                ...
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <div class="content table-responsive table-full-width">
                                            ...
                                            <form action="IngresaerGasto.jsp" method="post">                                                                                                                               
                                        ...
                                        <div class="content table-responsive table-full-width">
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    arr = (ArrayList<Gasto>) port.loadGastos();
                                            ...
                                            <table class="table order-table">
                                                ...
                                                <tr>
                                                <form method="post" action="ControladorGasto.jsp">
                                                    
                                                    <td><input type='text' size='45' name='detalle' maxlength='45' required></td>
                                                    <td><input type='date' size='15' name='fecha' maxlength='6' required></td>
                                                    <td><input type='text' size='10' name='total' maxlength='6' required></td>
                                                ...
                                                %>
                                                <tr>
                                                    <td><%=arr.get(i).getGastoDetalle()%></td>
                                                    <td><%=arr.get(i).getGastoFecha()%></td>
                                                    <td><%=arr.get(i).getGastoValor()%></td>   
                                                    <td><a href='#'><img tittle='ver detalle' alt='ver detalle' src='tema/img/detalle.png' width='30' height='30'></a></td>
                                                            </tr>
                                                            <%
