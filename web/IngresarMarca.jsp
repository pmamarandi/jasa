<%-- 
    ...
    Created on : 20-jun-2017, 14:17:28
    Author     : erick
--%>
...
<%
    ...
    %>
        <script>alert('División no registrada');</script>
    <%
    }
%>
                    <script>alert('Division registrada correctamente');
...
<head>
	...
	<title>Factime Ingreso Marcas</title>
		...
		<nav class="navbar navbar-default">
             <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">PRODUCTOS /Divisiones</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-4">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Nueva División</h4>
                            </div>
                            <div class="content">
                                <form id="form1" method="post" action="controladorIngresarMarca.jsp" name="registrar">
                                    <div class="row">                                        
                                        <div class="col-md-5">
