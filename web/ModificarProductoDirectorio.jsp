		...
		<nav class="navbar navbar-default">
             <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">DIRECTORIO /Modificar</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-4">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Editar Local Comercial</h4>
                            </div>
                            <div class="content">
              <form action="ControladorModificarProductoDirectorio.jsp" method="post">                                    
	...
	out.println(result);
         %>
                ...
                <div class="col-lg-5 col-md-4">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Imagen del local comercial</h4>
                               
                            </div>
                            <div class="content">
                                <form action="ControladorIngresarModImgDirectorio.jsp?id2=<%out.print(IdP);%>&cod2=<%out.print(codImg);%>&tipo=0" enctype="MULTIPART/FORM-DATA" method="post">                                                                                
             <%                  
	com.factime.ln.ws.FactimeLogicaNegocioDirectorio portimg = service.getFactimeLogicaNegocioDirectorioPort();
