<%-- 
    Document   : listarFacturasAnuladas
    Created on : 14/12/2015, 14:53:26
    Author     : Eddie-PC
--%>
...
return patron.test(te); 
  ...
  <body onLoad="setAnios()">
     ...
     <div class="grupo formato_tabla centrar-contenido"> 
            ...
            <div class="caja web-100 centro-contenido"> 
                <form action="ListarFacturasAnuladas.jsp" method="post" name="forma"> 
                <p>Ingresa la fecha: 
                ...
                try {
                    ...
                    String esTbl = port.listarFacturasAnuladas(mes,anio);
