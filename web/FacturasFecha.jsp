<%-- 
    Document   : FacturasFecha
    Created on : 12/08/2018, 17:16:02
    Author     : Yesenia
--%>
                                ...
                                <div class="col-md-12">
                                    <div class="card card-plain">                            
                                        <div class="header">
                                            ...
                                            <form action="FacturasFecha.jsp" method="post">                                                                                                                               
                                                <div class="col-md-3 form-group-sm">
                                                    <input size="15" maxlength="15" type="date" name="fecha" >
                                                    <br>
                                                </div>
                                        ...
                                        <div class="content table-responsive table-full-width">
                                            ...
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    arr = (ArrayList<Factura>) port.facturasPorFecha(fecha);
                                            ...
                                            <!--<form action="ReporteFacturaFecha.jsp" method="post">                                                                                                                               
                                                <div class="col-md-3 form-group-sm">
                                                    <input name="dato" size="15" maxlength="15" type="text" value="<%= fecha%>" class="light-table-filter form-control border-input" readonly >
                                                    <br>
                                                </div>
